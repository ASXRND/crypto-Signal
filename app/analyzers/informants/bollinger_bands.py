    ...
    def analyze(self, historical_data, period_count=21):
        ...
        if close_data.size > period_count:
            ...
            for index in range(period_count, bb_df_size):
                ...
                bb_values.loc[bb_values.index[index], 'lowerband'] = bb_data[0][data_index]
                bb_values.loc[bb_values.index[index], 'middleband'] = bb_data[1][data_index]
                bb_values.loc[bb_values.index[index], 'upperband'] = bb_data[2][data_index]
